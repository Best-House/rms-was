...
class FixedMaterialPriceTest {

    @Test
    public void containsTest() {
        Material material = new Material("material1","material1");
        MaterialPrice materialPrice = new FixedMaterialPrice(Map.of(material, 1.0));
    ...
    public void getPriceWithUnknownMaterial() {
        MaterialPrice materialPrice = new FixedMaterialPrice(Collections.EMPTY_MAP);
    ...
    public void getUnknownMaterials() {
        ...
        MaterialPrice materialPrice = new FixedMaterialPrice(Map.of(knownMaterial, 1.0));
